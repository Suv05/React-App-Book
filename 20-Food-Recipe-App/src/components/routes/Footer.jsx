...
function Footer({}) {
  return (
    <>
      <div className="px-5">
        <div className="grid grid-cols-2 bg-zinc-900 text-white rounded-t-xl font-noto-sans">
          ...
          <div className="grid grid-cols-3 pt-4">
            ...
            <div className="flex">
              <input
                type="text"
                className="bg-zinc-800 px-2 me-3 mb-2 focus:outline-none focus:ring-0 focus:outline-orange"
